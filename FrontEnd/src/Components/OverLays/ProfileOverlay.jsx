...
const ProfileOverlay = () => {
  ...
  return (
    <div>
       <div className="absolute top-full right-0 w-full md:w-[350px]  bg-gray-50 text-gray-700 p-2 rounded-md shadow-lg">
...
{/* Menu Items */}
{[
  { label: "My Courses", icon: "/assets/profile.png" ,link:'/LMS/courses'},
  { label: "My Favourites", icon: "/assets/favourites.png",link:'/LMS/favourites' },
  { label: "User Profile", icon: "/assets/calendar.png" ,link:'/LMS/UserProfile'},
