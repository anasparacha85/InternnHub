...
console.log(error);
  ...
  return (
    <div className="max-w-[80%] mx-auto px-6  py-4 shadow-lg rounded-lg mt-3 "  >
      {/* Profile Heading */}
      <div className="text-center">
      <h1 className="text-2xl font-bold mb-2 text-gray-400">Profile</h1>
...
<form onSubmit={onsubmit}>
      ...
      <div className="flex flex-col  gap-4">
        ...
        value={formdata.FirstName}
          ...
          className="p-2 border rounded-md w-full text-gray-400"
        ...
        name="Age"
          ...
          onChange={onchange}
          placeholder="Age"
          className="p-2 border rounded-md w-full md:col-span-2 text-gray-400"
        />
      </div>
      ...
      <div className="mt-6">
        ...
        <div className="flex space-x-2 mb-2">
          <button
            ...
            className="p-2 border rounded-md bg-gray-700 text-gray-400 hover:bg-gray-300"
          >
            <Bold size={18} />
          </button>
          <button
