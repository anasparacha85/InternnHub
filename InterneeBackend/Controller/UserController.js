...
const UpdateUserpassword=async(req,res)=>{
    try {
        ...
        res.status(200).json({SuccessMessage:"Credentials updated successfully!",data})
...
module.exports={getUserProfile,updateUserProfile,UpdateUserpassword,UpdateProfilePicture}